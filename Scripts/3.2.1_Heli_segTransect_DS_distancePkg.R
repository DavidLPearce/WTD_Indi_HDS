...
names(heli_dat)[2] <- "Area"              # Area in hectares
names(heli_dat)[3] <- "Sample.Label"      # Transect ID 
...
F23_DS_est <- data.frame(Model = "seg Heli DS",
                         Season = "Fall 2023",
                         Season_Model = "F23 seg Heli DS",
                         Data = "Helicopter",
...
# 
# # Export best model
# saveRDS(F23_DS_est, "./Model_Objects/F23_segHeli_DS_AbundEst.rds")
...
# Organize into a dataframe
W24_DS_est <- data.frame(Model = "seg Heli DS",
                         Season = "Winter 2024",
                         Season_Model = "W24 seg Heli DS",
                         Data = "Helicopter",
...
# Organize into a dataframe
F24_DS_est <- data.frame(Model = "seg Heli DS",
                         Season = "Fall 2024",
                         Season_Model = "F24 seg Heli DS",
                         Data = "Helicopter",
...
# Export best model
saveRDS(F24_DS_est, "./Model_Objects/F24_segHeli_DS_AbundEst.rds")
...
# Organize into a dataframe
W25_DS_est <- data.frame(Model = "seg Heli DS",
                         Season = "Winter 2025",
                         Season_Model = "W25 seg Heli DS",
                         Data = "Helicopter",
...
# Export best model
saveRDS(W25_DS_est, "./Model_Objects/W25_segHeli_DS_AbundEst.rds")
