...
# Directory for plots
output_dir <- "./Figures/LULC/1250segTransect/"
...
# Export data
write.csv(site_covs, "./Data/Survey_Data/Helicopter_Data/Heli_1250segTransect_siteCovs.csv")
