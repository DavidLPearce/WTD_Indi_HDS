...
# Colnames
unique(colnames(trans_site_covs))

# Remove site, lat, long
#X.abund <- trans_site_covs[,-c(2:3)]

# Mean and center scale values
trans_site_covs$woody_prp <- scale(trans_site_covs$woody_prp, center = TRUE, scale = TRUE)
trans_site_covs$herb_prp <- scale(trans_site_covs$herb_prp, center = TRUE, scale = TRUE)
trans_site_covs$open_prp <- scale(trans_site_covs$open_prp, center = TRUE, scale = TRUE)
trans_site_covs$woody_mnParea <- scale(trans_site_covs$woody_mnParea, center = TRUE, scale = TRUE)
trans_site_covs$herb_mnParea <- scale(trans_site_covs$herb_mnParea, center = TRUE, scale = TRUE)
trans_site_covs$woody_ClmIdx <- scale(trans_site_covs$woody_ClmIdx, center = TRUE, scale = TRUE)
trans_site_covs$herb_ClmIdx <- scale(trans_site_covs$herb_ClmIdx, center = TRUE, scale = TRUE)
trans_site_covs$woody_ShpInx <- scale(trans_site_covs$woody_ShpInx, center = TRUE, scale = TRUE)
trans_site_covs$herb_ShpInx <- scale(trans_site_covs$herb_ShpInx, center = TRUE, scale = TRUE)
trans_site_covs$woody_lrgPInx <- scale(trans_site_covs$woody_lrgPInx, center = TRUE, scale = TRUE)
trans_site_covs$herb_lrgPInx  <- scale(trans_site_covs$herb_lrgPInx, center = TRUE, scale = TRUE)
trans_site_covs$woody_AggInx <- scale(trans_site_covs$woody_AggInx, center = TRUE, scale = TRUE)
trans_site_covs$herb_AggInx  <- scale(trans_site_covs$herb_AggIn, center = TRUE, scale = TRUE)
trans_site_covs$woody_EdgDens <- scale(trans_site_covs$woody_EdgDens, center = TRUE, scale = TRUE)
trans_site_covs$herb_EdgDens  <- scale(trans_site_covs$herb_EdgDens, center = TRUE, scale = TRUE)
trans_site_covs$woody_Pdens <- scale(trans_site_covs$woody_Pdens, center = TRUE, scale = TRUE)
trans_site_covs$herb_Pdens  <- scale(trans_site_covs$herb_Pdens, center = TRUE, scale = TRUE)
trans_site_covs$woody_Npatches <- scale(trans_site_covs$woody_Npatches, center = TRUE, scale = TRUE)
trans_site_covs$herb_Npatches  <- scale(trans_site_covs$herb_Npatches, center = TRUE, scale = TRUE)
print(trans_site_covs)


# Export data
write.csv(trans_site_covs, "./Data/Survey_Data/Helicopter_Data/Heli_Transect_siteCovs.csv")
