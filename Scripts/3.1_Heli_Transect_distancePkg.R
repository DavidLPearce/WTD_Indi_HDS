...
fall23_dat <- fall23_dat[,-18]
win24_dat <- win24_dat[,-18]
fall24_dat <- fall24_dat[,-18]
win25_dat <- win25_dat[,-18]
...
# Goodness of fit
gof_ds(F23_hr_null, main = "Hazard-rate Null") # Chi-square shows a pretty good fit
...
# Goodness of fit
gof_ds(W24_hn_null, main = "Hazard-rate Null") # Chi-square shows a pretty good fit
...
# Goodness of fit
gof_ds(W24_hn_fit1, main = "Hazard-rate Null") # Chi-square shows a pretty good fit
...
# Goodness of fit
gof_ds(F24_hn_null, main = "Hazard-rate Null") # Chi-square shows a pretty good fit
...
# Plot detection probability by distance bin
plot(F24_hn_fit1, breaks= c(0,20,40,60,100), main = "WInter '24")

# Goodness of fit
gof_ds(F24_hn_fit1, main = "Hazard-rate Null") # Chi-square shows a pretty good fit


# Getting estimates of abundance
F24_abund <-  dht2(ddf = F24_hn_fit1$ddf,
                   flatfile = fall24_dat,
                   stratification = "replicate",
                   strat_formula = ~ replicate,
                   convert_units = conversion.factor
...
print(F24_abund, report = "density")   # Density of ~ 0.19 deer per hectare                  
print(F24_abund, report = "abundance") # Total abundance of 219 on property                       
