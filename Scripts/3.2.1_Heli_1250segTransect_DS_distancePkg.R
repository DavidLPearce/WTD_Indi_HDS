...
F23_DS_est <- data.frame(Model = "1250seg Heli DS",
                         Season = "Fall 2023",
                         Season_Model = "F23 1250seg Heli DS",
                         Data = "Helicopter",
...
# Organize into a dataframe
W24_DS_est <- data.frame(Model = "1250seg Heli DS",
                         Season = "Winter 2024",
                         Season_Model = "W24 1250seg Heli DS",
                         Data = "Helicopter",
...
# Organize into a dataframe
F24_DS_est <- data.frame(Model = "1250seg Heli DS",
                         Season = "Fall 2024",
                         Season_Model = "F24 1250seg Heli DS",
                         Data = "Helicopter",
...
# Organize into a dataframe
W25_DS_est <- data.frame(Model = "1250seg Heli DS",
                         Season = "Winter 2025",
                         Season_Model = "W25 1250seg Heli DS",
                         Data = "Helicopter",
