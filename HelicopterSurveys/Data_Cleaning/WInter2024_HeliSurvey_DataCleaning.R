...
# Read in Transects
transects <- st_read("./HelicopterSurveys/Helicopter_Transects_Updated/Helicopter_Transects_Updated.shp")

# Read the CSV file
HSwinter24_dat <- read.csv("./HelicopterSurveys/HelicopterSurvey_data/WInter2024_HelicopterSurveys.csv")
